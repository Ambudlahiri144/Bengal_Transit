  ...
  return (
    <>
      ...
      <main className="min-h-[100dvh] bg-gray-50 flex flex-col items-center justify-center p-4 sm:p-6 font-sans relative">
        ...
        <div
          className="absolute top-4 left-4 md:top-8 md:left-8 fade-up"
          style={{ animationDelay: visible ? '0ms' : '9999s' }}
        >
          <img
            src="/BAPL_logo.jpg"
        ...
        {/* Header block */}
        <div
          className="text-center mb-10 mt-24 md:mt-0 fade-up"
          style={{ animationDelay: visible ? '60ms' : '9999s' }}
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl w-full px-2 sm:px-4">
          ...
          {/* Card 1: Master Database */}
          <div className="fade-up" style={{ animationDelay: visible ? '160ms' : '9999s' }}>
          ...
          {/* Card 2: Flight Analytics */}
          <div className="fade-up" style={{ animationDelay: visible ? '250ms' : '9999s' }}>
          ...
          {/* Card 3: Agent Mode */}
          <div className="fade-up" style={{ animationDelay: visible ? '340ms' : '9999s' }}>
        ...
        {/* Logout — fades in last */}
        <button
          onClick={() => { sessionStorage.clear(); router.push('/login'); }}
          className="mt-10 md:mt-12 mb-6 md:mb-0 text-xs md:text-sm font-bold text-gray-400 hover:text-gray-600 uppercase tracking-widest transition-colors pb-safe fade-up"
          style={{ animationDelay: visible ? '430ms' : '9999s' }}
        >
          Secure Logout
        </button>
